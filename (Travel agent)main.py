...
jokes = [
    ...
    "I used to be a great tour guide, but I've lost my way!"
]
...
def recommend():
    ...
    if preference in destinations:
        ...
        print(Fore.RED + "TravelBot: Sorry, I don't have that type of desination.")
...
def packing_tips():
    ...
    print(Fore.YELLOW + "TravelBot: How many days?")
    days = input(Fore.CYAN + "You: ")
...
# Tell a random joke
def tell_joke():
    print(Fore.YELLOW + f"traavelbot : {random.choice(jokes)}")
